                            ...
                            <div class="row g-0 p-0">
                                <div class="col-lg-6 d-flex align-items-center justify-content-center text-white">
                                    <div class="card reg-card position-relative rounded-5">
                                        <img src="assets/img/login-image.jpg" class="card-img-top" alt="Registration Image">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="card-body p-md-5 mx-md-4">
                                        <div class="text-center">
                                            <h4 class="mt-1 mb-5 pb-1">We are Superfans</h4>
                                        </div>

                                        <form action="#" method="POST">
                                            <p class="text-center">Login to your account to use the API</p>
                                            <?php if (isset($error)) { ?>
                                                <p style="color: red;"><?php echo $error; ?></p>
                                            <?php } ?>
                                            <div class="form-outline mb-4">
                                                <label class="form-label" for="uname">Username</label>
                                                <input type="text" id="uname" name="uname" class="form-control" autofocus/>
                                            </div>
                                            <div class="form-outline mb-4">
                                            ...
                                            <div class="d-flex align-items-center justify-content-center pb-4">
                                                <p class="mb-0 me-2">I don't have an account? <a href="register.php" class="text-danger text-decoration-none fw-bold">Sign Up</a></p>
                                            </div>
                                        </form>
